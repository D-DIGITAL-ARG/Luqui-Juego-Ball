...
class Game {
    ...
    loadLevel(index) {
        ...
        document.querySelector('.level-indicator').innerText = displayLevel < 10 ? `NIVEL_0${displayLevel}` : `NIVEL_${displayLevel}`;
        this.updateScoreUI();

        // Basic Level Setup based on index (10 levels progressively harder)
        let cx = this.width / 2;
